        ...
        public AsyncTaskRunner(View view) {
            ...
            try {
                ...
                if (connect != null) {
                    ...
                    PreparedStatement verifyUser = connect.prepareStatement("Select * from agent where agentEmail=?");
                    ...
                    if(verifyUserResultset.next()&&!UserAccount.email.equalsIgnoreCase(emailProfile.getText().toString())) {
                        ...
                        PreparedStatement statement = connect1.prepareStatement("update agent set agentName=?, agentEmail=? , agentPassword=?  " +
                                " , agentPhone=? where agentEmail=?");
